...
import bmgHD from "../assets/bmgHD.png";
      ...
      <Wrapper>
        ...
        >
          <div className="font-light mb-4">
            👋 Hi, I Am{" "}
            <span className="font-semibold">Benigno Martinez G.</span>
          </div>
          <div className="max-w-[510px]">
            I develop and sustain state-of-the-art web applications. I address
            your business challenges by utilizing my expertise in HTML, CSS, and
            JavaScript, coupled with advanced frameworks like React and Node.js.
            My aim is to deliver solutions that are both robust and scalable.
          </div>
        </motion.div>
        {/* INTRO END */}
        ...
        >
          ...
          {/* START */}
          <div className="flex items-center gap-3">
            <div className="text-[80px] font-light">3+</div>
            <div className="leading-[22px]">
              YEARS OF
              <br />
              EXPERIENCE
