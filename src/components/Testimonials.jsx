...
import tavt1 from "../assets/t-avt-1.png";
import tavt2 from "../assets/t-avt-2.png";
import tavt3 from "../assets/t-avt-3.png";
          ...
          <Carousel>
            ...
            <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
              <div className="mb-[25px]">
                ...
                />
                <div className="font-bold">Emily Montero</div>
                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                  Client
                </div>
              </div>
              <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                Working with BMG Develop on LuxxLashess.com was a game-changer
                for our business. The website they built is not only visually
                stunning but also incredibly effective at attracting and
                converting customers. It's been a significant boost to our
                success
              </div>
            </div>
            {/* SLIDE END */}
            ...
            <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
              <div className="mb-[25px]">
                <img
                  ...
                  className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                />
                <div className="font-bold">Jessica Martinez</div>
                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                  Client
                </div>
              </div>
              <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                Zuse Investments couldn't be happier with BMG Develop. They
                revamped our website into a powerful tool for attracting
                investors. Exceptional work
              </div>
            </div>
            {/* SLIDE END */}
            {/* SLIDE START */}
            <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
              <div className="mb-[25px]">
                <img
                  ...
                  className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                />
                <div className="font-bold">Anthony Cruz</div>
                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                  Client
                </div>
              </div>
              <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                Cruz Auto Shop's website, developed in collaboration with BMG
                Develop, exceeded our expectations. Their expertise and
                meticulous attention to detail transformed our online presence,
                leading to a substantial boost in customer engagement and
                business growth. We wholeheartedly recommend their services.
              </div>
            </div>
            {/* SLIDE END */}
          </Carousel>
