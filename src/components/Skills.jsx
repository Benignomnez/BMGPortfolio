        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            <Service
              num="1"
              title="UI/UX Design"
              desc="Highlighting my approach to intuitive and user-friendly interface designs."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
            ...
            <Service
              ...
              desc="Showcasing my expertise in crafting visually compelling designs that resonate with the target audience."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
            ...
            <Service
              ...
              desc="Focused on building high-quality, interactive web interfaces that offer seamless user experiences."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
            ...
            <Service
              ...
              desc="Specializing in creating and optimizing WordPress sites for functionality and user engagement."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
